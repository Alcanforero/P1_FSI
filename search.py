...
def tree_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print "Numero de nodos expandidos:", expandedNodes
            return node
...
def ramificacion_acotacion_subestimation_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, RamifiSaltoSub(problem))

def ramificacion_acotacion_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, RamifiSalto(problem))
